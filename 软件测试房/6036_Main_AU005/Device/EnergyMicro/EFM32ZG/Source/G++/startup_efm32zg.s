 ...
 *           Energy Micro EFM32ZG Device Series
 ******************************************************************************
 *
...
__cs3_interrupt_vector_em:
    ...
    .long   Reserved4_Handler           /* Reserved                     */
    .long   Reserved5_Handler           /* Reserved                     */
    .long   Reserved6_Handler           /* Reserved                     */
    ...
    .long   Reserved12_Handler          /* Reserved                     */
...
_IRQHandlerinterrupt:
    ...
    .globl  Reserved4_Handler
    .set    Reserved4_Handler, _IRQHandlerinterrupt
    .weak   Reserved5_Handler
    .globl  Reserved5_Handler
    .set    Reserved5_Handler, _IRQHandlerinterrupt
    .weak   Reserved6_Handler
    .globl  Reserved6_Handler
    .set    Reserved6_Handler, _IRQHandlerinterrupt
    ...
    .globl  Reserved12_Handler
    .set    Reserved12_Handler, _IRQHandlerinterrupt
